...
io.on('connection', async (socket) => {
  ...
  // (PR-H3). ICE candidate signalling stays here for now — it covers both the
  // legacy P2P signalling and the room-broadcast fallback used by other
  // stream consumers and is not exclusive to the streaming handler group.
  ...
  // The closely-named `stop-stream` event below is ViewBot-rotation specific
  // and stays here (slated for PR-H5: ViewBotHandler).
