...
/**
 * Test LiveKit ViewBot with Puppeteer
 */

const ViewBotLiveKitPuppeteer = require('./server/services/ViewBotLiveKitPuppeteer');

async function testLiveKitPuppeteer() {
  console.log('🧪 Testing LiveKit ViewBot with Puppeteer...\n');
  ...
  // Initialize service
  const viewbotService = new ViewBotLiveKitPuppeteer(mockLivekitService);
  ...
  try {
    ...
    console.log(`   The ViewBot successfully streamed to LiveKit!`);
