// Default per-tab markdown content, used when the API returns no override
// for a given tab. Extracted verbatim from Tutorial.tsx (dates remain dynamic).

export const getDefaultAboutContent = (): string => {
...
export const getDefaultSupportContent = (): string => {
    return `# Support & Help
...
export const getDefaultTutorialContent = (): string => {
...
export const getDefaultPrivacyContent = (): string => {
...
export const getDefaultTermsContent = (): string => {
